...
const bgcolor1 =
  'w-10 h-10 bg-yellow-500 text-white text-lg font-quicksand p-2 font-bold rounded-full flex items-center justify-center';
const bgcolor2 =
  'w-10 h-10 bg-pink-500 text-white text-lg font-quicksand p-2 font-bold rounded-full flex items-center justify-center';
const bgcolor3 =
  'w-10 h-10 bg-green-500 text-white text-lg font-quicksand p-2 font-bold rounded-full flex items-center justify-center';
const bgcolor4 =
  'w-10 h-10 bg-red-500 text-white text-lg font-quicksand p-2 font-bold rounded-full flex items-center justify-center';
      ...
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-start gap-3 cursor-pointer">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-inter text-sm text-gray-800">{post.subject}</p>
