...
const Login = () => {
  ...
  const notify = () => toast.promise(signIn("google", {callbackUrl: 'http://localhost:3000'}), {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res?.error == null) {
            ...
            toast.error("Email not registered or wrong password", { id: toastLoading })
        }
    } catch (error) {
      toast.error(error)
      console.log(err)
  ...
  return (
    ...
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <p className='desc text-left max-w-md font-inter'>
        Sign in to enjoy all the amazing features i.e taking lives quizzes and personalizing your quizzes by adding questions to your dasboard
      </p>
